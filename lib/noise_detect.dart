...
class NoiseDetect extends StatefulWidget {
  @override
  _NoiseDetectState createState() => _NoiseDetectState();
}

class _NoiseDetectState extends State<NoiseDetect> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        body: SafeArea(child: RecorderExample(),),
    );
  }
}
